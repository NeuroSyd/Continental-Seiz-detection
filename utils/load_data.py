...
def calc_stft(s_):
    ...
    stft_data = stft.spectrogram(s,framelength=80,centered=False)
        ...
        while True: 
            ...
            if len(fn_full) == 1:
                ...
                while (st+i)*250+window_len < sp*250: 
                    ...
                    assert prep_s.shape == (1, 13, 20, 126)
                ...
                if cl=="seiz":
                    for i_a in range(6):
                        if st-i_a-1 >= 0:
                            ...
                            print ('Additional raw time-series shape', st-i_a-1, s.shape, int((st-i_a-1)*250), int((st-i_a-1)*250)+window_len)
                            assert s.shape[1] == window_len
                            prep_s = calc_stft(s)
...
if __name__ == "__main__":   
    ...
    cachedir = '/mnt/data7_M2/tempdata/tuh_7s_stft'
