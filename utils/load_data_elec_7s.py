        ...
        while True: 
            ...
            if len(fn_full) == 1:
                ...
                while (st+i)*250+window_len < sp*250: 
                    ...
                    assert prep_s.shape == (1, 13, 2, 125)
                ...
                if cl=="seiz":
                    for i_a in range(4):
                        if st-i_a-3 >= 0:
                            ...
                            diff2 = s[13:14, :] - s[17:18, :]
                            s = np.concatenate((diff1, diff2), axis=0)
                            print ('Additional raw time-series shape', st-i_a-3, s.shape, int((st-i_a-3)*250), int((st-i_a-3)*250)+window_len)
...
if __name__ == "__main__":   
    ...
    cachedir = '/mnt/data7_M2/tempdata/tuh_7s_stft_2ch_O1P3_F3F7_train_whole'
